...
export default class Donut extends Component {
  ...
  createChart() {
    this.chart = this.props.chart.create(this.rootNode, this.props.data, this.getChartConfiguration());
  }

  updateChart() {
    this.props.chart.update(this.rootNode, this.props.data, this.getChartConfiguration(), this.chart);
  }

  render() {
    const { chart, loadingState } = this.props;
    return loadingContainerWrapper(this.props, loadingState || chart.loading(), React.createElement('div', { className: 'donut-container', ref: this.setRef }));
  }
}
Donut.propTypes = {
  /**
