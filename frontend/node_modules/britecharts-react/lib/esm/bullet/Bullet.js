...
class Bullet extends React.Component {
    ...
    getChartConfiguration() {
        let configuration = _extends({}, this.props);
    ...
    render() {
        ...
        return loadingContainerWrapper(this.props, loadingState || chart.loading(), React.createElement('div', { className: 'bullet-container', ref: this.setRef }));
    }
}
