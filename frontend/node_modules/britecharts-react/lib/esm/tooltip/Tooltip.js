...
export default class Tooltip extends React.Component {
    ...
    constructor(props) {
        ...
        this.createTooltip = () => {
            const tooltipWithMarkerContainer = this.rootNode.querySelector(tooltipContainerWithMarkerSelector);
            const tooltipContainer = this.rootNode.querySelector(tooltipContainerSelector);

            if (tooltipWithMarkerContainer || tooltipContainer) {
                this.chart = this.props.chart.create(tooltipWithMarkerContainer || tooltipContainer, this.getChartConfiguration());
            }
        };
    ...
    componentDidUpdate() {
        ...
        if (tooltipWithMarkerContainer || tooltipContainer) {
            this.chart = this.props.chart.update(tooltipWithMarkerContainer || tooltipContainer, this.getChartConfiguration(), this.state, this.chart);
        }
    }
    ...
    handleMouseOut() {
        // Update Tooltip State
        this.setState(state => _extends({}, state, { isActive: false }));
    ...
    handleMouseOver() {
        // Update Tooltip State
        this.setState(state => _extends({}, state, { isActive: true }));
    ...
    getChartConfiguration() {
        const configuration = _extends({}, this.props);
    ...
    render() {
        return React.createElement(
            'div',
            { className: 'tooltip-chart-wrapper', ref: this.setRef },
            this.childChart
        );
    }
}
